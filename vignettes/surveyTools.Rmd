...
provide functionality to coerce input to this representation via functions
`as_eq5d3l()`, `as_eq5d5l()` and `as_eq5dy()`.
...
For further details about the available value sets please consult the
documentation of the wrapped package via
